...
public final class SectionsQuery implements DayTimeArgObserver{
    ...
    /**
     * toString for debuging
     */
    @Override
    public String toString(){
        StringBuilder sb = new StringBuilder();
        sb.append("Base Size: ").append(cBaseSections.size()).append("\n")
                .append("Results Size: ").append(cResults.size()).append("\n")
                .append("Term: ").append(cTerm).append("\n")
                .append("Course: ").append(cCourse).append("\n")
                .append("Availability: ").append(cAvailability).append("\n")
                .append("Campuses: ").append(cCampuses).append("\n")
                .append("Sections: [");
                
        for (Section s : cSections)
            sb.append(s.sectionNumber()).append(", ");
        
                sb.append("]").append("\n")
                .append("Sessions: ").append(cSessions).append("\n")
                .append("Methods: ").append(cInstructionalMethods).append("\n")
                .append("Instructors: ").append(cInstructors).append("\n")
                .append("Day Time Args: ").append(cDayTimeArgs).append("\n");
    ...
    //************************************************************************************************
    /**
     * Sets the <code>Term</code> of this <code>SectionsQuery</code>, recalculates <code>results()</code>, 
    ...
    * The <code>DayTimeArgObserver</code> will be notified when <code>minStart()</code> and <code>maxEnd()</code>changes.
    ...
    public static class DayTimeArg{
        ...
        @Override
        public String toString(){
            return "[day=" + this.cDay + ", minStart=" + this.minStart() + ", maxEnd=" + this.cMaxEnd + "]";
        }
